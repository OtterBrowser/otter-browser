...
QT += core gui multimedia network printsupport script webkitwidgets widgets xmlpatterns
...
HEADERS += src/core/ActionsManager.h \
    ...
    src/modules/importers/opera/OperaSessionImporter.h \
