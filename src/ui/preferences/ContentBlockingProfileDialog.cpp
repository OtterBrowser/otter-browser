...
void ContentBlockingProfileDialog::save()
{
	...
	else
	{
		...
		ContentBlockingProfile *profile(new ContentBlockingProfile(QList<QString>(), url, QDateTime(), fileName, m_ui->titleEdit->text(), m_ui->updateIntervalSpinBox->value(), category));
