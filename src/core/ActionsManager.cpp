	...
	m_reloadTimer(0)
{
	...
	registerAction(MediaPlayBackRateAction, QT_TRANSLATE_NOOP("actions", "Playback Rate"), QString(), QIcon(), ActionDefinition::WindowScope, (ActionDefinition::IsEnabledFlag | ActionDefinition::IsCheckableFlag));
