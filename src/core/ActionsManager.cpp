	...
	m_reloadTimer(0)
{
	...
	registerAction(ShowLinkAsQuickResponseCodeAction, QT_TRANSLATE_NOOP("actions", "Show Link as QR Code…"), {}, {}, ActionDefinition::WindowScope, ActionDefinition::IsEnabledFlag, ActionDefinition::LinkCategory);
