	...
	m_reloadTimer(0)
{
	...
	registerAction(MuteTabMediaAction, QT_TRANSLATE_NOOP("actions", "Mute Tab Media"), QString(), ThemesManager::createIcon(QLatin1String("audio-volume-medium")), ActionDefinition::WindowScope, ActionDefinition::NoFlags);
	...
	registerAction(LoadPluginsAction, QT_TRANSLATE_NOOP("actions", "Load Plugins"), QString(), ThemesManager::createIcon(QLatin1String("preferences-plugin")), ActionDefinition::WindowScope);
	...
	registerAction(ClearHistoryAction, QT_TRANSLATE_NOOP("actions", "Clear History…"), QString(), ThemesManager::createIcon(QLatin1String("edit-clear-history")), ActionDefinition::MainWindowScope);
