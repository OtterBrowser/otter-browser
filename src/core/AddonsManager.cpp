...
AddonsManager::AddonsManager(QObject *parent) : QObject(parent)
{
	...
	registerSpecialPage(SpecialPageInformation(QT_TRANSLATE_NOOP("addons", "Tab History"), {}, {}, ThemesManager::createIcon(QLatin1String("view-history"), false), SpecialPageInformation::SidebarPanelType), QLatin1String("tabHistory"));
