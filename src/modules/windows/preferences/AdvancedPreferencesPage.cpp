	...
	m_ui(new Ui::AdvancedPreferencesPage)
{
	...
	connect(m_ui->javaScriptOptionsButton, &QPushButton::clicked, this, &AdvancedPreferencesPage::updateJavaScriptOptions);
...
void AdvancedPreferencesPage::updateJavaScriptOptions()
{
